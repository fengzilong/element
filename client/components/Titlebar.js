	...
	template: `
		<div class="titlebar">
			<div class="titlebar-stoplight">
				<div class="titlebar-close" on-click="{ this.onClose() }">
				...
				<div class="titlebar-minimize" on-click="{ this.onMinimize() }">
					<svg x="0px" y="0px" viewBox="0 0 8 1.1">
						<rect fill="#995700" width="8" height="1.1"></rect>
					</svg>
				</div>
				<div class="titlebar-fullscreen" on-click="{ this.onMaxmize() }">
